// test_validation.ts — Unit tests for the GraphQL mutation validation pattern.
// Run: npx ts-node test_validation.ts
// Or with a test runner: npx ts-node test_validation.ts --test

import { validateInput, collectErrors } from "./validation";
import { rules, userRules, postRules } from "./rules";
import { isValidEmail, normalizeEmail } from "./scalars";
...
function testValidateInputCollectsAllErrors(): void {
...
function testCollectErrorsReturnsArray(): void {
...
function testCollectErrorsEmptyForValidInput(): void {
...
function testRequiredRule(): void {
...
function testMinLengthRule(): void {
...
function testMaxLengthRule(): void {
...
function testUserRulesSet(): void {
  const validInput = {
    name: "Alice",
...
function testPostRulesSet(): void {
  const validInput = {
    id: "123",
    title: "My Post Title",
    body: "This is a long enough body for the post.",
    status: 1,
  };
